				...
				<form name="courseForm" method="POST" action="addCourse.do">
					...
					<table class="main-table" cellpadding="0" cellspacing="0" align="center">
						...
						<tr >
							...
							<td>
								<input type="number" name="course.courseTime" value="">
							</td>
						</tr>
						<tr >
							<td class="first">
							...
							<td>
								<input type="text" name="course.courseCredit" value="">
							</td>
						</tr>
						<tr class="light">
							<td  class="first">
							...
							<td>
								<select name="course.teacherId">
									<c:forEach items="${userlist}" var="user" varStatus="status">
										<option value="${user.id }" <c:if test="${status.first}">selected</c:if>>
											${ user.userName}
										</option>
									</c:forEach>
								</select>
